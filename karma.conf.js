...
module.exports = function(config) {
  config.set({
    ...
    files: [
      ...
      'node_modules/@ebay/jquery-mouse-exit/jquery.mouseexit.js',
      'node_modules/@ebay/jquery-button-flyout/jquery.buttonflyout.js',
      'jquery.linkflyout.js',
      'test.js'
    ],
